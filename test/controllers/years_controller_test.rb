...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { bc_ad: @year.bc_ad, listing_id: @year.listing_id, year: @year.year } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { bc_ad: @year.bc_ad, listing_id: @year.listing_id, year: @year.year } }
